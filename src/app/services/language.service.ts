...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    tooltipText: 'Specify a range of illustrations to download. Use \'-\' for open-ended ranges (e.g., \'5-\' for all images from the 5th image onwards, \'-20\' for all up to 20, \'5-20\' for all images between 5 and 20).',
    download: 'Download',
    downloading: 'Downloading...',
    downloadedImagesNumber: 'Images downloaded',
  ...
  ja: {
    ...
    enterUrl: '...xiv.net/../artworks/<illustration_id>',
    enterRange: '範囲（任意）',
    tooltipText: 'ダウンロードするイラストの範囲を指定してください。開放範囲には「-」を使用ください. (例:「5-」は5枚目の画像以降すべて、「-20」は20枚目の画像まですべて、「5-20」は5枚目から20枚目までのすべての画像).',
    download: 'ダウンロード',
    downloading: 'ダウンロード中...',
    downloadedImagesNumber: '枚の画像をダウンロードしました',
